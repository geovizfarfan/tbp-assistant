...
CREATE TABLE IF NOT EXISTS booster_payments (
  id SERIAL PRIMARY KEY,
  user_id TEXT NOT NULL,
  guild_id TEXT NOT NULL,
  amount INTEGER,
...
-- Same idea as rr_stats, tracked separately for Rumble Slaughter.
...
ALTER TABLE rr_guild_config ADD COLUMN IF NOT EXISTS achievement_log_channel_id TEXT;
...
ALTER TABLE level_config ADD COLUMN IF NOT EXISTS enabled BOOLEAN NOT NULL DEFAULT FALSE;
