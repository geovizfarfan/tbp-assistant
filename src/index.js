...
client.on('interactionCreate', async (interaction) => {
  ...
  if (interaction.isUserSelectMenu() && interaction.customId === 'serversetup_levelsetuser') {
    const serverSetupModule = require('./commands/serversetup/serversetup');
    return serverSetupModule.handleLevelSetUserPicked(interaction);
  }
  if (interaction.isChannelSelectMenu() && interaction.customId === 'serversetup_levelexcludeaddchan') {
    const serverSetupModule = require('./commands/serversetup/serversetup');
    return serverSetupModule.handleLevelExcludeAddPicked(interaction);
  }
  if (interaction.isChannelSelectMenu() && interaction.customId === 'serversetup_levelexcluderemovechan') {
    const serverSetupModule = require('./commands/serversetup/serversetup');
    return serverSetupModule.handleLevelExcludeRemovePicked(interaction);
  }
  ...
  if (interaction.isRoleSelectMenu() && interaction.customId === 'serversetup_bulkremoverole') {
    const serverSetupModule = require('./commands/serversetup/serversetup');
    return serverSetupModule.handleBulkRemoveRolePicked(interaction);
  }
  if (interaction.isStringSelectMenu() && interaction.customId === 'serversetup_seasoninfopick') {
    const serverSetupModule = require('./commands/serversetup/serversetup');
    return serverSetupModule.handleSeasonInfoPicked(interaction);
  }
  if (interaction.isStringSelectMenu() && interaction.customId === 'serversetup_seasonendpick') {
    const serverSetupModule = require('./commands/serversetup/serversetup');
    return serverSetupModule.handleSeasonEndPicked(interaction);
  }
  if (interaction.isStringSelectMenu() && interaction.customId === 'serversetup_seasonaddchanpick') {
    const serverSetupModule = require('./commands/serversetup/serversetup');
    return serverSetupModule.handleSeasonAddChanPicked(interaction);
  }
  if (interaction.isStringSelectMenu() && interaction.customId === 'serversetup_seasonremovechanpick') {
    const serverSetupModule = require('./commands/serversetup/serversetup');
    return serverSetupModule.handleSeasonRemoveChanPicked(interaction);
  }
  if (interaction.isStringSelectMenu() && interaction.customId === 'serversetup_seasonlinkpick') {
    const serverSetupModule = require('./commands/serversetup/serversetup');
  ...
  if (interaction.isChannelSelectMenu() && interaction.customId.startsWith('serversetup_seasonremovechanselect:')) {
    const serverSetupModule = require('./commands/serversetup/serversetup');
    return serverSetupModule.handleSeasonRemoveChanSelected(interaction);
  }
  if (interaction.isButton() && interaction.customId.startsWith('serversetup_seasonendconfirm:')) {
    const serverSetupModule = require('./commands/serversetup/serversetup');
    return serverSetupModule.handleSeasonEndConfirm(interaction);
  }
  if (interaction.isButton() && interaction.customId === 'serversetup_levelresetconfirm') {
    const serverSetupModule = require('./commands/serversetup/serversetup');
    return serverSetupModule.handleLevelResetConfirm(interaction);
  }
  ...
  if (interaction.isButton() && interaction.customId.startsWith('serversetup_bulkremove_all:')) {
    const serverSetupModule = require('./commands/serversetup/serversetup');
    return serverSetupModule.handleBulkRemoveAllStart(interaction);
  }
  if (interaction.isButton() && interaction.customId.startsWith('serversetup_bulkremove_allconfirm:')) {
    const serverSetupModule = require('./commands/serversetup/serversetup');
    return serverSetupModule.handleBulkRemoveAllConfirm(interaction);
  }
  if (interaction.isButton() && interaction.customId.startsWith('serversetup_bulkremove_specific:')) {
    const serverSetupModule = require('./commands/serversetup/serversetup');
    return serverSetupModule.handleBulkRemoveSpecificStart(interaction);
  }
  ...
  if (interaction.isModalSubmit() && interaction.customId.startsWith('serversetup_bulkremovemodal:')) {
    const serverSetupModule = require('./commands/serversetup/serversetup');
    return serverSetupModule.handleBulkRemoveSpecificModal(interaction);
  }
  if (interaction.isModalSubmit() && interaction.customId === 'serversetup_seasonstartmodal') {
    const serverSetupModule = require('./commands/serversetup/serversetup');
    return serverSetupModule.handleSeasonStartModal(interaction);
  }
  ...
  if (interaction.isModalSubmit() && interaction.customId.startsWith('serversetup_levelsetmodal:')) {
    const serverSetupModule = require('./commands/serversetup/serversetup');
    return serverSetupModule.handleLevelSetModal(interaction);
  }
  ...
  if (interaction.isModalSubmit() && interaction.customId === 'serversetup_ticketpanelrepostmodal') {
    const serverSetupModule = require('./commands/serversetup/serversetup');
    return serverSetupModule.handleTicketPanelRepostModal(interaction);
  }
  if (interaction.isModalSubmit() && interaction.customId === 'serversetup_ticketpanelremovemodal') {
    const serverSetupModule = require('./commands/serversetup/serversetup');
    return serverSetupModule.handleTicketPanelRemoveModal(interaction);
  }
